<?php
    ...
    function getPuntuaciones($cantidad){
         ...
         $sql = "SELECT * from puntuaciones ORDER by tp DESC,  dg DESC ";
...
function getColaboradores($cantidad)
{
    include 'conexion/conexion.php';
...
//funciones detalles del servicio
...
function enviar_email($post){
    ...
    if(mail('maicolsilver94@hotmail.es', $post['asunto'], $post['mensaje'], $headers)){
