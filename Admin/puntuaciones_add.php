...
<div class="wrapper">
  ...
  <?php
    ...
    if( isset($_POST) ){
        ...
        if($_POST['guardar'] == 'guardar' && $_POST['equipo'] != '' && $_POST['pj'] != '' && $_POST['pg'] != '' && $_POST['pe'] != '' && $_POST['pp'] != '' && $_POST['gf'] != ''
        && $_POST['gc'] != '' && $_POST['dg'] != '' && $_POST['tp'] != '' && $_POST['avatar'] != '' && $_POST['activo'] != ''){
            ...
            $sql = 'INSERT INTO puntuaciones (equipo, pj, pg, pe, pp, gf, gc, dg, tp, avatar, activo, fecha_add) VALUES (:equipo, :pj, :pg, :pe, :pp, :gf, :gc, :dg, :tp, :avatar, :activo, NOW() )';
           ...
           $query = $connection->prepare($sql);
            ...
            try{
                 ...
                 if( $query->execute($data) ){
                     ...
                     echo '<script> window.location = "puntuaciones.php"; </script>';
 ...
 <?php include 'includes/mensajes.php';?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="panel">
        <div class="row">
            <form action="puntuaciones_add.php" method="POST" name="form">
                <div class="form-group col-md-4">
                    <label>Equipos</label>
                    <input type="text" name="equipo" required class="form-control">
                </div>

                 <div class="form-group col-md-2">
                    <label>PJ</label>
                    <input type="text" name="pj" required class="form-control">
                </div>

                <div class="form-group col-md-2">
                    <label>PG</label>
                    <input type="text" name="pg" required class="form-control">
                </div>

                <div class="form-group col-md-2">
                   <label>PE</label>
                   <input type="text" name="pe" required class="form-control">
               </div>

               <div class="form-group col-md-2">
                   <label>PP</label>
                   <input type="text" name="pp" required class="form-control">
               </div>

               <div class="form-group col-md-2">
                  <label>GF</label>
                  <input type="text" name="gf" required class="form-control">
              </div>

              <div class="form-group col-md-2">
                  <label>GC</label>
                  <input type="text" name="gc" required class="form-control">
              </div>

              <div class="form-group col-md-2">
                 <label>DG</label>
                 <input type="text" name="dg" required class="form-control">
             </div>

             <div class="form-group col-md-2">
                 <label>TP</label>
                 <input type="text" name="tp" required class="form-control">
             </div>
